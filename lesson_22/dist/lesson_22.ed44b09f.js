...
var WeatherApi = function () {
  ...
  _createClass(WeatherApi, [{
    key: 'getMyWeather',
    value: function getMyWeather(сity_name) {
      return fetch('https://api.openweathermap.org/data/2.5/weather?q=' + сity_name + '&appid=' + this.api).then(function (res) {
        if (res.status === 200) {
          return res.json();
        }
    ...
    key: 'setWeather',
    value: function setWeather(setTemp) {
...
bycity.addEventListener('click', function () {
  var city = document.getElementById('city');
  if (city.value) {
    dom.showPreloader();
    weather.getMyWeather(city.value).then(function (res) {
      weather.setWeather(res);
      dom.hidePreloader();
    }).catch(function (eror) {
      dom.hidePreloader();
...
},{"./location_api":10,"./dom":11,"./weather_api":12}],9:[function(require,module,exports) {
...
//# sourceMappingURL=/lesson_22.ed44b09f.map