...
var WeatherApi = function () {
  ...
  _createClass(WeatherApi, [{
    key: 'getMyWeather',
    value: function getMyWeather() {
      return fetch('https://api.openweathermap.org/data/2.5/weather?q=' + this.сity_name + '&appid=' + this.api).then(function (res) {
        if (res.status === 200) {
          return res.json();
        }
...
weather.getMyWeather().then(function (res) {
...
// });
},{"./location_api":10,"./dom":11,"./weather_api":24}],27:[function(require,module,exports) {
...
//# sourceMappingURL=/lesson_21%20example.63a60f7a.map